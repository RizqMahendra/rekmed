...
<div class="pasien-form">
    ...
    <!-- hendra change -->
    <?= $form->field($model, 'jenis_layanan')->dropDownList([ 'Umum' => 'Umum', 'JKN-BPJS' => 'JKN-BPJS', ]) ?>
    <div id="detail_layanan" style="display:none;">
...
$script = <<< JS
    $(function(){
        ...
        if($('#pasien-jenis_layanan').val() === "JKN-BPJS"){
            $('#detail_layanan').show();
        }else{
            $('#detail_layanan').hide();
        }

        $('#pasien-jenis_layanan').change(function() {
            if($( this ).val() === "JKN-BPJS"){
                $('#detail_layanan').show();
            }else{
                $('#detail_layanan').hide();
            }
