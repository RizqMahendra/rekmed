    ...
    <div class="row static-info">
        ...
        <div class="col-md-6 name">
            <?php 
                ...
                echo $pasien->getAge($kunjungan['mr0']['tanggal_lahir'])." Tahun"."<br/>";
                echo Html::encode($kunjungan['mr0']['jenis_layanan'])."<br/>";
                if($kunjungan['mr0']['jenis_layanan'] != "Umum"){
                    echo Html::encode($kunjungan['mr0']['no_BPJS'])."<br/>";
                }
            ?>
        </div>
    </div>
